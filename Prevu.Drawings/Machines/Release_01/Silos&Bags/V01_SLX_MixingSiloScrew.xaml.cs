...
{
  /// <summary>
  /// Logica di interazione per V01_SLX_MixingSiloScrew.xaml
  /// </summary>
  public partial class V01_SLX_MixingSiloScrew : UserControl
  {
    public static readonly DependencyProperty ComponentNameProperty =
    DependencyProperty.Register(nameof(ComponentName), typeof(string), typeof(V01_SLX_MixingSiloScrew),
    ...
    public static readonly DependencyProperty TrendNameProperty =
      DependencyProperty.Register(nameof(TrendName), typeof(string), typeof(V01_SLX_MixingSiloScrew),
    ...
    DependencyProperty.Register(nameof(Color), typeof(FillColor), typeof(V01_SLX_MixingSiloScrew),
    ...
    public V01_SLX_MixingSiloScrew()
    {
      InitializeComponent();
    }
