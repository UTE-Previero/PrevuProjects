...
{
  /// <summary>
  /// Logica di interazione per V01_SLX_Silo_wAgitator.xaml
  /// </summary>
...
new FrameworkPropertyMetadata(default(string), FrameworkPropertyMetadataOptions.AffectsRender, ComponentNameChangedCallback));
    ...
    public static readonly DependencyProperty TrendNameProperty =
      DependencyProperty.Register(nameof(TrendName), typeof(string), typeof(V01_SLX_Silo_wAgitator),
    ...
    DependencyProperty.Register(nameof(Color), typeof(FillColor), typeof(V01_SLX_Silo_wAgitator),
